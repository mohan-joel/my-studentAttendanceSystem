<?php 
  ...
  if(isset($_POST['update'])){
        ...
        $query = "update classes set class_name='$class_name', section_name='$section_name' where id='$id'";
        $result = mysqli_query($con, $query);
        if($result){
          redirect("show-classes.php","Class Updated Successfully!!!");
        }else{
          redirect("show-classes.php","Unable to updated class!!!");
        }
  }
                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample"  method="post">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="exampleInputUsername1" name="class_name" value="<?=$class['class_name'];?>">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Section Name</label>
                          <input type="text" class="form-control" id="exampleInputEmail1" name="section_name" value="<?=$class['section_name'];?>">
                        </div>
                    <?php  }?>
                        <!-- <div class="form-group">  
